...
public class Phonebook {
    ...
    public boolean addPhoneNumber(String new_phone, String person_id)  {
    ...
    public boolean deletePhoneNumber(String id) throws SQLException {
    ...
    public String getPersonIdFromPhoneNumber (String phone) throws SQLException {
        String owner = "";
